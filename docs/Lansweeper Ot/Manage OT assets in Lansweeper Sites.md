...
This page is for Lansweeper Sites. For Lansweeper On-premises, see [Manage OT assets in Lansweeper On-premises](/classic/docs/manage-ot-assets-in-lansweeper-on-premises).

Once you’ve installed Lansweeper, [scanned your OT environment](/classic/docs/scan-your-ot) you can manage your OT assets from your Lansweeper Site.
...
OT assets can also be viewed by creating [custom dashboards](/classic/docs/manage-dashboards) or [reports](/classic/docs/manage-reports).

From the **OT** view, you can sort your OT assets by [multiple columns](/classic/docs/view-assets#sort) or [create advanced filters and custom views](/classic/docs/view-assets#filter).
...
1. In your Lansweeper Site, go to **Inventory > Asset types > OT**. You can also search or [create an advanced filter](/classic/docs/view-assets#h54067037961674828386919) to locate your OT assets.
...
[Custom fields](/classic/docs/edit-assets#customfield) can also be created and added to OT assets.
