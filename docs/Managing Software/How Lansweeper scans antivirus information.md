...
![how-lansweeper-scans-anti-virus-information-2.jpg](/docs/.document360/assets/article_143/image_002.jpg)
...
![how-lansweeper-scans-anti-virus-information-3.jpg](/docs/.document360/assets/article_143/image_003.jpg)  
...
- It pulls data from the AntiVirusProduct WMI (Windows Management Instrumentation) class, found in the `\root\SecurityCenter` or `\root\SecurityCenter2` (Windows Security Center) namespace. In the **Software > Antivirus** tab of individual computer webpages, you can identify antivirus records pulled from WMI by the "bug" icon.
  ...
  ![how-lansweeper-scans-anti-virus-information-4.jpg](/docs/.document360/assets/article_143/image_004.jpg)
- It looks at the software list in the **Software** tab of a computer's webpage (which mimics Add/Remove Programs) and verifies whether an installed software package is part of the list of known antivirus software found in the web console under **Software > Anti-Virus Settings**. If a software package listed in a computer's **Software** tab is part of the list of known antivirus software, the computer is deemed to have antivirus software installed.![menu-software-anti-virus-settings.jpg](/docs/.document360/assets/article_143/image_005.jpg)![how-lansweeper-scans-anti-virus-information-5.jpg](/docs/.document360/assets/article_143/image_006.jpg)![how-lansweeper-scans-anti-virus-information-6.jpg](/docs/.document360/assets/article_143/image_007.jpg)
