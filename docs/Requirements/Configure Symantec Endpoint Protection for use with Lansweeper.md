...
3. Select the **Firewall** tab.  
   ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-1.jpg](/docs/.document360/assets/article_161/image_001.jpg)
4. Select the existing policy applied to your client machines on the right and choose **Edit the policy**. Alternatively, create a new policy to apply to your clients.
   ...
   ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-2.jpg](/docs/.document360/assets/article_161/image_002.jpg)
5. In the policy pop-up, select the **Rules** tab.
6. Select the **Add Rule...** button.

   ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-3.jpg](/docs/.document360/assets/article_161/image_003.jpg)
7. Give your rule a name, e.g. "Lansweeper". Select **Next** to continue.

   ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-4.jpg](/docs/.document360/assets/article_161/image_004.jpg)
8. Tick **Allow connections**. Select **Next** to continue.

   ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-5.jpg](/docs/.document360/assets/article_161/image_005.jpg)
9. Tick **All Applications**. Select **Next** to continue.

   ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-6.jpg](/docs/.document360/assets/article_161/image_006.jpg)
10. Tick **Any computer or site**. Select **Next** to continue.

    ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-7.jpg](/docs/.document360/assets/article_161/image_007.jpg)
11. Tick **All types of communication (all protocols and ports, local and remote)**. Select **Next** to continue.

    ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-8.jpg](/docs/.document360/assets/article_161/image_008.jpg)
12. Optionally, you can choose to have a log entry generated when a connection is made by the Lansweeper server. Select **Finish** to create the rule.
    ...
    ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-9.jpg](/docs/.document360/assets/article_161/image_009.jpg)
13. Once the rule has been created, double-click in the **Host** column and submit your Lansweeper server's IP address, to only apply the rule to traffic coming from your Lansweeper server.   
    ...
    ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-10.jpg](/docs/.document360/assets/article_161/image_010.jpg)

    ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-11.jpg](/docs/.document360/assets/article_161/image_011.jpg)

    ![configuring-symantec-endpoint-protection-for-use-with-lansweeper-12.jpg](/docs/.document360/assets/article_161/image_012.jpg)
