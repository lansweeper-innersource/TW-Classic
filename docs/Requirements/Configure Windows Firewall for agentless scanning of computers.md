...
2. Browse to one of the sections listed below. Which one you have depends on your OS.
   ...
   ![configuring-windows-firewall-for-agentless-scanning-of-computers-1.jpg](/docs/.document360/assets/article_162/image_002.jpg)
3. Right-click one of the settings listed below and choose **Edit.** Which one you have depends on your OS.
   ...
   - Windows Firewall: Allow remote administration exception![configuring-windows-firewall-for-agentless-scanning-of-computers-2.jpg](/docs/.document360/assets/article_162/image_003.jpg)
4. Select the **Enabled** option to enable the group policy.

   ![configuring-windows-firewall-for-agentless-scanning-of-computers-3.jpg](/docs/.document360/assets/article_162/image_004.jpg)
5. In the options under **Allow unsolicited incoming messages from these IP addresses**, enter your Lansweeper scanning server's IP address and continue. Alternatively, submit the "\*" wildcard to allow traffic from all IP addresses.
   ...
   ![configuring-windows-firewall-for-agentless-scanning-of-computers-4.jpg](/docs/.document360/assets/article_162/image_005.jpg)
...
7. Verify whether your policy is correctly applied. You can do this by running the below command on a machine.  
   ...
   ![configuring-windows-firewall-for-agentless-scanning-of-computers-5.jpg](/docs/.document360/assets/article_162/image_006.jpg)
