...
### Lansweeper platform[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi?_gl=1*2xcj6l*_gcl_au*Nzk2NzE4MjgyLjE3MzA3OTUwODY.*_ga*MTkwNDc1NTY2Mi4xNzE0OTgxODI4*_ga_22W23LECE0*MTczMjAwMjg2Ni43MzYuMS4xNzMyMDMzMDEyLjE0LjAuMjEyNTY3MjIxMg..#lansweeper-platform "Direct link to Lansweeper Platform")
...
### Lansweeper Power BI Import script[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi?_gl=1*2xcj6l*_gcl_au*Nzk2NzE4MjgyLjE3MzA3OTUwODY.*_ga*MTkwNDc1NTY2Mi4xNzE0OTgxODI4*_ga_22W23LECE0*MTczMjAwMjg2Ni43MzYuMS4xNzMyMDMzMDEyLjE0LjAuMjEyNTY3MjIxMg..#lansweeper-power-bi-dashboard-template "Direct link to Lansweeper Power BI Dashboard template")
...
## Prerequisites[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi?_gl=1*2xcj6l*_gcl_au*Nzk2NzE4MjgyLjE3MzA3OTUwODY.*_ga*MTkwNDc1NTY2Mi4xNzE0OTgxODI4*_ga_22W23LECE0*MTczMjAwMjg2Ni43MzYuMS4xNzMyMDMzMDEyLjE0LjAuMjEyNTY3MjIxMg..#prerequisites "Direct link to Prerequisites")
...
### Generate a Personal Access Token on Lansweeper[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi?_gl=1*2xcj6l*_gcl_au*Nzk2NzE4MjgyLjE3MzA3OTUwODY.*_ga*MTkwNDc1NTY2Mi4xNzE0OTgxODI4*_ga_22W23LECE0*MTczMjAwMjg2Ni43MzYuMS4xNzMyMDMzMDEyLjE0LjAuMjEyNTY3MjIxMg..#generating-identity-code-on-lansweeper-platform "Direct link to Generating Identity Code on Lansweeper Platform")

An API token is needed to make use of the Lansweeper Data API. This can be generated by following the steps below.

#### Create a PAT API Client on Lansweeper Sites[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi?_gl=1*2xcj6l*_gcl_au*Nzk2NzE4MjgyLjE3MzA3OTUwODY.*_ga*MTkwNDc1NTY2Mi4xNzE0OTgxODI4*_ga_22W23LECE0*MTczMjAwMjg2Ni43MzYuMS4xNzMyMDMzMDEyLjE0LjAuMjEyNTY3MjIxMg..#creating-a-new-application-on-lansweeper-portal "Direct link to Creating a new application on Lansweeper portal")
...
The `API Token` won't be visible again, so please store it for future use. For more information, check [authorization section](https://developer.lansweeper.com/classic/docs/data-api/get-started/quickstart#personal-access-token-pat) from the Data API documentation.

### Get Site IDs[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi?_gl=1*2xcj6l*_gcl_au*Nzk2NzE4MjgyLjE3MzA3OTUwODY.*_ga*MTkwNDc1NTY2Mi4xNzE0OTgxODI4*_ga_22W23LECE0*MTczMjAwMjg2Ni43MzYuMS4xNzMyMDMzMDEyLjE0LjAuMjEyNTY3MjIxMg..#get-site-ids "Direct link to Get Site Ids")
...
### Import Lansweeper data into Power BI Desktop[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi#creating-a-new-dashboard-template-in-power-bi "Direct link to Creating a new dashboard template in Power BI")
...
NOTE: The script uses the Lansweeper Data API [assetResources query.](https://developer.lansweeper.com/classic/docs/data-api/reference/assetresources) You need to be familiar with the Lansweeper Data API in order to modify the query and change the fields you want to import into Power BI. Please have also a look at the [Lansweeper Data API restrictions](https://developer.lansweeper.com/classic/docs/data-api/get-started/restrictions).
...
## Troubleshoot[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi#troubleshooting "Direct link to Troubleshooting")
...
### Refresh is not working or it is taking too much time[​](https://docs.lansweeper.com/classic/docs/api/use-cases/powerbi#refresh-is-not-working-or-it-is-taking-too-much-time "Direct link to Refresh is not working or it is taking too much time")
