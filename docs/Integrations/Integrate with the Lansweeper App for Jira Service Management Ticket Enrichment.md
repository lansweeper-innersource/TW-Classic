...
4. Select **Get it now > Get it now**. The installation process begins. Once installed, a message will appear on the bottom left, indicating that installation has been successful.  
   ![Lansweeper-App-Jira-Get.png](/docs/.document360/assets/article_092/image_002.jpg)
...
1. Select **Apps >** **Manage your apps**.  
   ![manage-apps.png](/docs/.document360/assets/article_092/image_003.jpg)
...
6. Select **Validate and Save**. The configuration parameters are validated, and the Lansweeper credentials are authenticated. Upon successful validation and authentication, a success message will appear.  
   ![validate-and-save.png](/docs/.document360/assets/article_092/image_004.jpg)
...
![asset-details.png](/docs/.document360/assets/article_092/image_006.jpg)![](https://files.document360.io/21d5935c-1b73-44fa-bf5a-a8b0f5c67f25/Images/Documentation/lansweeper-app-for-jira---release-documentation-and-user-guide-new-image-erpfdcwt.png)
...
![matches.png](/docs/.document360/assets/article_092/image_008.jpg)
...
![selected.png](/docs/.document360/assets/article_092/image_009.jpg)
