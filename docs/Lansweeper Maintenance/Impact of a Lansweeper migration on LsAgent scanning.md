...
- Ensure that your migrated installation effectively takes over LsAgent scan retrieval.
  ...
  2. Select **Override Relay Access**.  
     ![LsAgent_Migrate_Override.jpg](/docs/.document360/assets/article_104/image_002.jpg)
...
4. Choose one of the following options:
   ...
   - **Using the same external LansweeperDB**  
     ...
     3. Wait for this configuration change to sync down to your LsAgent clients, which may take up to 24 hours. The clients will start sending scanned data to the new server.![LsAgent_Migrate_Link.jpg](/docs/.document360/assets/article_104/image_003.jpg)
