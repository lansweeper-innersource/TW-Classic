...
1. Browse to the **Configuration > Your Lansweeper License**section of the web console.![menu-configuration-your-lansweeper-license.jpg](/docs/.document360/assets/article_095/image_002.jpg)
2. Select **Check for Updates now**. You could also tick **Automatically check for updates once a week** to perform periodic update checks. When periodic update checks are enabled and an update is available, you are notified through a pop-up when logging into the web console.![checking-for-lansweeper-updates-1.jpg](/docs/.document360/assets/article_095/image_003.jpg)
3. Review the page on the Lansweeper website that you're redirected to. This page indicates whether your installation is up-to-date. If your installation is not up-to-date, update it by following [these instructions](/docs/update-lansweeper-on-premises).![checking-for-lansweeper-updates-2.jpg](/docs/.document360/assets/article_095/image_004.jpg)  
