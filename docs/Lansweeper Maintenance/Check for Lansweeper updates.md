...
It is recommended that you [update your Lansweeper installation](/classic/docs/update-lansweeper-on-premises) on a regular basis, to ensure that you have the latest available patches installed and access to any new features that have been released. Updates are free to anyone with an active Lansweeper license.
...
3. Review the page on the Lansweeper website that you're redirected to. This page indicates whether your installation is up-to-date. If your installation is not up-to-date, update it by following [these instructions](/classic/docs/update-lansweeper-on-premises).  
