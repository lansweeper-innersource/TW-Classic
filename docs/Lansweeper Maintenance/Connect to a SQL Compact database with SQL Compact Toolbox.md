...
![procedure-checking-database-server.jpg](/docs/.document360/assets/article_096/image_001.jpg)  
...
3. Run the Toolbox executable as an administrator on your Lansweeper server.![connecting-to-a-sql-compact-database-with-sql-compact-toolbox-1.jpg](/docs/.document360/assets/article_096/image_002.jpg)
4. Right-click **No SQL Server Compact Data Connections** **found** and choose **Add SQL Server Compact 4.0 Connection...**in the menu.  
   ![connecting-to-a-sql-compact-database-with-sql-compact-toolbox-2.jpg](/docs/.document360/assets/article_096/image_003.jpg)
5. Select **Browse...** in the resulting pop-up and select your Lansweeper database file. The default path of the file is `Program Files (x86)\Lansweeper\SQLData\lansweeperdb.sdf`.![connecting-to-a-sql-compact-database-with-sql-compact-toolbox-3.jpg](/docs/.document360/assets/article_096/image_004.jpg)
6. Click the **Close** button in the pop-up window.![connecting-to-a-sql-compact-database-with-sql-compact-toolbox-4.jpg](/docs/.document360/assets/article_096/image_005.jpg)
7. Expand the Lansweeper database so you can view and query database tables.![connecting-to-a-sql-compact-database-with-sql-compact-toolbox-5.jpg](/docs/.document360/assets/article_096/image_006.jpg)  
