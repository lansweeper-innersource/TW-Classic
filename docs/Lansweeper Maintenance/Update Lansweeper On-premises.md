...
This page is for Lansweeper On-prem. For [Lansweeper Sites](https://www.lansweeper.com/product-overview/), see [Update your Lansweeper scan server](/classic/docs/update-your-lansweeper-sites-scan-server).

Lansweeper now includes an auto-update feature to help you stay up to date. For more information on auto-update, check out [Enable the Lansweeper scan server to auto-update](/classic/docs/enable-the-lansweeper-scan-server-to-auto-update). If you still want to update manually however, follow the instructions in this article.
...
2. [Back up](/classic/docs/back-up-your-installation) your installation, to be safe.
