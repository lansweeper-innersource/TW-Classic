...
Most of the data scanned by Lansweeper and manually submitted in the web console is stored in the Lansweeper database. Your database is hosted in either the Microsoft SQL LocalDB, Microsoft SQL Server or (deprecated) Microsoft SQL Compact database server. You would have selected your preferred database server [when you installed Lansweeper](/docs/install-lansweeper-on-prem).
...
- `|DataDirectory|\lansweeperdb.sdf`, your database server is SQL Compact.   
  SQL Compact is no longer supported or offered as a database server option for Lansweeper. If you are still using SQL Compact as your Lansweeper database server, you should [convert your database to SQL LocalDB or SQL Server](/docs/convert-a-deprecated-sql-compact-database).  
  ![identify-which-database-server-lansweeper-is-using-1.jpg](/docs/.document360/assets/article_103/image_001.jpg)
- `(localdb)\.\LSInstance`, your database server is SQL LocalDB.  
  ![identify-which-database-server-lansweeper-is-using-2.jpg](/docs/.document360/assets/article_103/image_002.jpg)
- Something else, your database server is SQL Server.   
  ...
  ![identify-which-database-server-lansweeper-is-using-3.jpg](/docs/.document360/assets/article_103/image_003.jpg)
...
- `SQL Compact`, your database server is SQL Compact.   
  SQL Compact is no longer supported or offered as a database server option for Lansweeper. If you are still using SQL Compact as your Lansweeper database server, you should [convert your database to SQL LocalDB or SQL Server](/docs/convert-a-deprecated-sql-compact-database).  
  ![identify-which-database-server-lansweeper-is-using-4.jpg](/docs/.document360/assets/article_103/image_004.jpg)
- `SQL Server: (localdb)\.\LSInstance`, your database server is SQL LocalDB.   
  ...
  ![identify-which-database-server-lansweeper-is-using-5.jpg](/docs/.document360/assets/article_103/image_005.jpg)
- `SQL Server` followed by something other than `(localdb)\.\LSInstance`, your database server is SQL Server.  
  ...
  ![identify-which-database-server-lansweeper-is-using-6.jpg](/docs/.document360/assets/article_103/image_006.jpg)
