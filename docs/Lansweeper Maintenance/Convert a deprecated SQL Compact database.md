...
2. Stop the **Lansweeper Server** service in Windows Services. ![procedure-stopping-the-lansweeper-service.jpg](/docs/.document360/assets/article_098/image_002.jpg)
...
9. Run CompactToServer.exe found at `Program Files (x86)\Lansweeper\Tools\CompactToServer.exe` on the machine hosting your Lansweeper service. ![menu-compacttoserver.jpg](/docs/.document360/assets/article_098/image_005.jpg)
10. Select the upper **Browse...** button, select the lansweeperdb.sdf file you created a backup of earlier and select **Open**. If you chose SQL Server as your preferred database server, you may also need to select the lower **Browse...** button to select your SQL Server instance. The schema versions of the source and destination databases should match, indicating that they're both on the same Lansweeper version. Select **Migrate Database** to start the migration process. Note that depending on the size of your database, this process may take a while to complete.![moving-your-database-from-sql-compact-to-sql-localdb-4.jpg](/docs/.document360/assets/article_098/image_006.jpg)
11. Restore the Website subfolders and Encryption.txt file you created a backup of earlier. Afterward, restart the Lansweeper and web server services in Windows Services. ![procedure-starting-the-web-server-service.jpg](/docs/.document360/assets/article_098/image_007.jpg)
...
5. Stop the **Lansweeper Server** service in Windows Services.  
   ![procedure-stopping-the-lansweeper-service.jpg](/docs/.document360/assets/article_098/image_008.jpg)
...
12. Run CompactToServer.exe, found at `Program Files (x86)\Lansweeper\Tools\CompactToServer.exe` on the machine hosting your Lansweeper service. ![menu-compacttoserver.jpg](/docs/.document360/assets/article_098/image_011.jpg)
13. Select the upper **Browse...** button, select the lansweeperdb.sdf file you created a backup of earlier and select **Open**. If you chose SQL Server as your preferred database server, you may also need to click the lower **Browse...** button to select your SQL Server instance. The schema versions of the source and destination databases should match, indicating that they're both on the same Lansweeper version. Select **Migrate Database** to start the migration process. Note that depending on the size of your database, this process may take a while to complete.![moving-your-database-from-sql-compact-to-sql-localdb-4.jpg](/docs/.document360/assets/article_098/image_012.jpg)
14. Restore the Website subfolders and Encryption.txt file you created a backup of earlier. Afterward, restart the Lansweeper and web server services in Windows Services. ![procedure-starting-the-web-server-service.jpg](/docs/.document360/assets/article_098/image_013.jpg)
