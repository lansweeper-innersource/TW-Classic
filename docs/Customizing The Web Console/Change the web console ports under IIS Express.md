...
1. Stop **IIS Express service** in Windows Services.![procedure-stopping-the-web-server-service.jpg](/docs/.document360/assets/article_032/image_001.jpg)
...
3. Search for "bindingInformation" and replace your current HTTP and HTTPS ports with custom (free) ports of your choice.  
   ![changing-the-web-console-ports-under-iis-express-1.jpg](/docs/.document360/assets/article_032/image_002.jpg)
4. Restart **IIS Express service** in Windows Services.![procedure-starting-the-web-server-service.jpg](/docs/.document360/assets/article_032/image_003.jpg)
...
7. Optionally, have Lansweeper redirect HTTP traffic to HTTPS by ticking **Force https when configured** in the **Configuration > Website Settings**section of the web console. You may need to restart **IIS Express service** again to make the change take effect.  
   ![menu-configuration-website-settings.jpg](/docs/.document360/assets/article_032/image_004.jpg)

   ![changing-the-web-console-ports-under-iis-express-3.jpg](/docs/.document360/assets/article_032/image_005.jpg)  
