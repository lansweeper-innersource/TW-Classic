...
By default, everyone in your network can access all of Lansweeper's features and menus simply by browsing to the web console URL and selecting **Built-in Admin**. You can also restrict access to the console to certain Windows users and configure what those users can see or do once they've been granted access. Info on restricting web console access can be found in [this knowledge base article](/classic/docs/restrict-access-to-the-web-console). As explained in the last step of the aforementioned article, it is possible to have your browser automatically log you into the console with the Windows user account currently logged into your computer.
