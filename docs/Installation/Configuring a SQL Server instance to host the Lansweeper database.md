...
![configuring-an-existing-sql-instance-to-host-the-lansweeper-database-1.jpg](/docs/.document360/assets/article_074/image_001.jpg)
...
1. Make sure the SQL Server and SQL Server Browser services are running at all times on the server hosting your SQL instance.
   - Right-click one of the services in Windows Services.  
     ![procedure-checking-sql-service-status.jpg](/docs/.document360/assets/article_074/image_002.jpg)
   - Select the **Properties** menu item.  
     ![procedure-checking-sql-service-properties.jpg](/docs/.document360/assets/article_074/image_003.jpg)
   - Set the service's startup type to **Automatic** in the resulting pop-up and click **OK**.  
     ![procedure-checking-sql-service-startup-type.jpg](/docs/.document360/assets/article_074/image_004.jpg)
   - Right-click the service and select **Start**, if the service is not already started.  
     ![procedure-starting-sql-service.jpg](/docs/.document360/assets/article_074/image_005.jpg)
2. Make sure your SQL instance is configured for mixed (Windows and SQL) authentication, as the Lansweeper service and web console will use a SQL user called "lansweeperuser" to connect to the database.   
   ...
   - Select the **Properties** menu item.
     ...
     ![procedure-checking-sql-instance-properties.jpg](/docs/.document360/assets/article_074/image_006.jpg)
   - Select the **Security** tab in the resulting pop-up.
   - Tick **SQL Server and Windows Authentication mode  
     ![procedure-checking-sql-server-authentication.jpg](/docs/.document360/assets/article_074/image_007.jpg)**
   - Right-click your SQL instance name and select **Restart**.  
     ![procedure-restarting-sql-instance.jpg](/docs/.document360/assets/article_074/image_008.jpg)
3. If your Lansweeper service and/or web console will be hosted on a different server than the Lansweeper database, make sure your SQL instance is set up to allow remote database connections.
   - Right-click your SQL instance name in SQL Server Management Studio, select **Properties** and open the **Connections** tab in the resulting pop-up. Select **Allow remote connections to this server**. **![procedure-enabling-remote-connections-in-management-studio.jpg](/docs/.document360/assets/article_074/image_009.jpg)**...
   ...
   - Right-click **Named Pipes** and select **Enable**, right-click **TCP/IP** and select **Enable**.  
     ![procedure-checking-sql-protocols.jpg](/docs/.document360/assets/article_074/image_010.jpg)
   - Right-click **TCP/IP**, select **Properties** and ensure that connectivity is enabled for the appropriate IPs in the IP Addresses tab.  
     ![procedure-checking-sql-protocol-ips.jpg](/docs/.document360/assets/article_074/image_011.jpg)
   - Right-click the SQL Server service under SQL Server Services and select **Restart**.  
     ![procedure-restarting-sql-service-in-configuration-manager.jpg](/docs/.document360/assets/article_074/image_012.jpg)
...
5. With your SQL Server and firewall configuration taken care of, follow the instructions in [this article](/docs/install-lansweeper-on-prem#heading2 "Advanced install Lansweeper") to install Lansweeper. The SQL instance name you submit in the Lansweeper installer should match what you see in SQL Server Management Studio. The installer will connect to the instance and create the lansweeperdb database. Don't try to manually create the database, as this will likely cause an installation failure.
   ...
   ![procedure-checking-sql-instance-name-in-management-studio.jpg](/docs/.document360/assets/article_074/image_013.jpg)

   ![configuring-an-existing-sql-instance-to-host-the-lansweeper-database-2.jpg](/docs/.document360/assets/article_074/image_014.jpg)
