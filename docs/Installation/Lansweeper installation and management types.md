...
1. **A Cloud-first installation**: the inventory and scanning configuration is managed from [a Cloud-based site](http://app.lansweeper.com/). This is also known as a [Cloud-first site](/classic/docs/install-lansweeper-sites).
2. **A local on-premise installation**: the inventory and scanning configuration is managed from a locally installed web console. This is known as an [On-premise installation](/classic/docs/install-lansweeper-on-prem).
...
To set up a Cloud-first installation, see [Install Lansweeper Sites](/classic/docs/install-lansweeper-sites).

A Cloud-first installation differs from a Cloud-first trial installation, as the trial installer is uniquely linked to a specific cloud site. If you want to try the Cloud-First trial instead, see [Install the Lansweeper Cloud-first trial](/classic/docs/install-the-lansweeper-trial).
...
To set up a Lansweeper On-prem installation, see [Install Lansweeper On-prem](/classic/docs/install-lansweeper-on-prem).
...
To set up a Hybrid installation, you must [install Lansweeper On-prem](/classic/docs/install-lansweeper-on-prem) first. Afterwards, [link your on-premise installation to a Lansweeper cloud site](/classic/docs/link-lansweeper-on-prem-with-lansweeper-sites).
...
During the installation process, you will have to enter your license key in the [First Run Wizard](/classic/docs/install-lansweeper-on-prem#FRW).
...
Depending on your needs, you may find that the Cloud management type is still suitable. If you are interested in the On-prem web console, for example, you could enable the console by following the steps in [Enable the Lansweeper Classic web console](/classic/docs/enable-the-lansweeper-on-premises-web-console).
...
4. Optionally, you can link your On-prem installation to a cloud site again. For more information on linking your On-prem installation, see [Link Lansweeper On-prem with Lansweeper Sites](/classic/docs/link-lansweeper-on-prem-with-lansweeper-sites).
...
For more information on unlinking your installations, see [Remove an installation from your site](/classic/docs/remove-an-installation-from-your-cloud-site).
...
2. Unlink all installations linked to your cloud site, and remove all data. For more information on unlinking your installations, see [Remove an installation from your site](/classic/docs/remove-an-installation-from-your-cloud-site).
3. Uninstall all on-premise installations.
4. Reinstall Lansweeper in Cloud-first mode. For more information on installation Lansweeper Cloud-first, see [Install Lansweeper Sites](/classic/docs/install-lansweeper-sites).
