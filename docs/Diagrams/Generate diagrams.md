...
5. In the **Status** column select  to generate a diagram.  
   Alternatively, you can select the name of the diagram, then **Generate Diagram**.  
...
- Go to **Diagrams**, find your desired diagram, then select  under the **Status** column.
- Go to **Diagrams** and open your diagram by selecting the name of your desired diagram. In the bottom right-hand corner, select .  
