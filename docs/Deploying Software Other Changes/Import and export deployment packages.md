...
1. Browse to the **Deployment > Deployment packages**section of the web console.![menu-deployment-deployment-packages.jpg](/docs/.document360/assets/article_061/image_001.jpg)
2. To export a package, select the package and select **Export**, above the package name and description.![importing-and-exporting-deployment-packages-1.jpg](/docs/.document360/assets/article_061/image_002.jpg)
3. To import a package, select **Import**, select the **Browse...** button in the resulting pop-up, select your .xml file and click **OK**.![importing-and-exporting-deployment-packages-2.jpg](/docs/.document360/assets/article_061/image_003.jpg)  
