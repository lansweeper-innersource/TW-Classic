...
Risk Insights has been greatly improved in version 10.5.0.7. We recommend [updating your installation](http://lansweeper.com/knowledgebase/updating-your-installation/ "updating your installation") if you are running a lower Lansweeper version to ensure an optimized experience.
...
1. Go to **Risk Insights > Active vulnerabilities**, and select **Customize view**. **![Custom vulnerability views 5.png](/docs/.document360/assets/article_050/image_002.jpg)**
2. Under **Fixed columns,**toggle the fixed columns that you want to display **On**or **Off**.
...
5. Select **Apply**.
6. If you're happy with the view, select **Unsaved View > Save view and configurations**. If you'd like to revert to the previous view, select **Restore the default value**. **![Custom vulnerability views 8.png](/docs/.document360/assets/article_050/image_003.jpg)**
...
1. Go to **Risk Insights > Active vulnerabilities**, and select **Advanced filter view**.  
   ![Custom vulnerability views 6.png](/docs/.document360/assets/article_050/image_004.jpg)
2. Type in a field name or select the arrow to view a list of options.
...
3. Select **Custom view**. From there, you have a variety of options to manage the custom view.  
   ![Custom vulnerability views 9.png](/docs/.document360/assets/article_050/image_005.jpg)
...
1. Go to **Risk Insights > Active vulnerabilities**, and select **Export view**.  
   ![Custom vulnerability views 7.png](/docs/.document360/assets/article_050/image_006.jpg)
...
4. Select **Export**.  
   ![Export report 2.png](/docs/.document360/assets/article_050/image_007.jpg)
