...
2. Choose the **Single Sign-On** menu and select **Add new managers** next to the relevant SSO connection.  
   ![add-cloud-sso-manager.png](/docs/.document360/assets/article_373/image_002.jpg)
...
![add-cloud-sso-manager-popup.png](/docs/.document360/assets/article_373/image_003.jpg)
