...
2. Go to the **Enterprise applications** menu and select **New application**.  
   ![azure-ad-new-enterprise-application.jpg](/docs/.document360/assets/article_309/image_002.jpg)
3. Select **Create your own application**.  
   ![azure-ad-create-own-application.jpg](/docs/.document360/assets/article_309/image_003.jpg)
4. In the resulting pop-up, enter a descriptive name for your application and select **Integrate any other application you don't find in the gallery (Non-Gallery)**.  
   ![azure-ad-integrate-other-application.jpg](/docs/.document360/assets/article_309/image_004.jpg)
5. Finally, select **Create**.

## Configure your SSO app

1. In the **Single sign-on** menu of your newly created app, select SAML.  
   ![azure-ad-sso-saml.jpg](/docs/.document360/assets/article_309/image_005.jpg)
...
3. Select **Edit** under **Basic SAML Configuration**.  
   ![azure-ad-basic-saml-configuration.jpg](/docs/.document360/assets/article_309/image_006.jpg)
...
6. Copy the SingleLogout Service (SLO) URL from the **Add SSO Connection** pop-up in Lansweeper and paste it into the **Logout Url** field.  
   ![azure-ad-save-basic-saml-configuration.jpg](/docs/.document360/assets/article_309/image_007.jpg)
7. Select **Save**.
8. In the **SAML Signing Certificate** section of your app's SSO config, download the Base64 certificate. Upload it in the **Add SSO Connection** pop-up in Lansweeper.  
   ![azure-ad-saml-signing-certificate.jpg](/docs/.document360/assets/article_309/image_008.jpg)
9. In the **Set up <Your App Name>** section of your app's SSO config, copy the Login URL.  
   ![azure-ad-sso-url.jpg](/docs/.document360/assets/article_309/image_009.jpg)
...
11. In the **Attributes & Claims** section of your app's SSO config, select **Edit**.   
    ![azure-ad-saml-attributes-claims.jpg](/docs/.document360/assets/article_309/image_010.jpg)
12. Choose **Add new claim**, configure the new claim as mentioned below and select **Save**.  
    ...
    - Name: `email_verified`
    - Source: Attribute
    - Source attribute: `true`![azure-ad-saml-add-claim.jpg](/docs/.document360/assets/article_309/image_011.jpg)
...
13. In the **Users and groups** menu of your app, select **Add user/group**.  
    ![azure-ad-app-users-groups.jpg](/docs/.document360/assets/article_309/image_012.jpg)
