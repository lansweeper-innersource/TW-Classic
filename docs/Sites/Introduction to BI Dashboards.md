...
If you want to modify dashboard items, you’ll first need to enter **Edit mode**.
...
1. Select the dashboard item you want to modify.
2. Select  **Data**.
3. Select  **Settings** for the field you want to customize.
...
If you want to duplicate the entire dashboard instead, select  **Duplicate dashboard**.

### Add alerts to dashboard items

1. Hover over the dashboard item you want to add an alert for, and select  **Set an alert**.
...
If you want to delete the entire dashboard instead, select  **Delete dashboard**.
...
1. Hover over the dashboard item you want to save, and select  **Download**.
