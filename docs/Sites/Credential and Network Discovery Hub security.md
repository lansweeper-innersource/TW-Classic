...
This page is for Lansweeper Sites. For Lansweeper On-prem, see [Credential and database security](/classic/docs/credential-and-database-security-in-lansweeper).
