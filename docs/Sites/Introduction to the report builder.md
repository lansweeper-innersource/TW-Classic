...
![introduction_to_ADP_report_builder_5.jpg](/docs/.document360/assets/article_317/image_002.jpg)
...
![introduction_to_ADP_report_builder_1.jpg](/docs/.document360/assets/article_317/image_003.jpg)
...
![introduction_to_ADP_report_builder_6.jpg](/docs/.document360/assets/article_317/image_004.jpg)
...
1. Go to the **Reports** module and select **Create new report**.  
   ![introduction_to_ADP_report_builder_2-1.jpg](/docs/.document360/assets/article_317/image_005.jpg)
2. In the **New report** view, select **Fields** to choose the fields you want to report on.  
   ![introduction_to_ADP_report_builder_3.jpg](/docs/.document360/assets/article_317/image_006.jpg)
3. Choose a collection of fields. For example, if you'd like to report on asset and/or software data, select the **Device and software** collection.  
   ![introduction_to_ADP_report_builder_4.jpg](/docs/.document360/assets/article_317/image_007.jpg)
4. Select the fields you want to report on. In our example, we are using "Asset Name", "First Seen", "Last Seen", and "Software Name". Select **Apply**to continue.  
   ![Cloud report 1.png](/docs/.document360/assets/article_317/image_008.jpg)
...
5. Enter the value you want to filter on. In our example, we enter "VMware".  
   ![Cloud report 2.png](/docs/.document360/assets/article_317/image_009.jpg)The result pane immediately shows a limited example of the filtered data.![Cloud report 3.png](/docs/.document360/assets/article_317/image_010.jpg)You can add more filter criteria by clicking "**+**" and repeating the previous steps.![Cloud report 4.png](/docs/.document360/assets/article_317/image_011.jpg)

### Group the filtered results

1. Add a new step by selecting **Add step**.
2. Select **Group** to add your grouping criteria. In our example, we select to group by "Software Name".![Cloud report 5.png](/docs/.document360/assets/article_317/image_012.jpg)To see the result count, tick the **Show results count** option.![Cloud report 6.png](/docs/.document360/assets/article_317/image_013.jpg)
...
2. In the pop-up window, enter a name and description, and choose the category you want to save your report in.  
   ![Cloud report 7.png](/docs/.document360/assets/article_317/image_014.jpg)
3. After a report is saved, it gets added to the report running queue.   
   ...
   ![Introduction-to-the-ADP-report-builder-13.jpg](/docs/.document360/assets/article_317/image_015.jpg)
