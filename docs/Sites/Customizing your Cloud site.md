...
Only the default Administrator role can customize the site. More information regarding roles can be found in [this knowledge base article](/classic/docs/configure-scopes-permissions-and-roles).
...
- Toggle [Multi-factor authentication](/classic/docs/enable-multi-factor-authentication-mfa)
- Toggle [Single Sign-On](/classic/docs/set-up-lansweeper-sso)
- Current site's Site ID
- Toggle [Normalized software](/classic/docs/software-data-normalization)
- [Delete the current site](/classic/docs/delete-cloud-sites-and-accounts)
