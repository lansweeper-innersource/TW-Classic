...
A local [Lansweeper](https://www.lansweeper.com/) installation can be [linked with a Site](/classic/docs/link-lansweeper-on-prem-with-lansweeper-sites). Linking a local installation causes the installation's current data and any subsequent data changes to be sent to Lansweeper Sites. The Sites interface offers [a number of advantages](/classic/docs/introduction-to-lansweeper-sites) over the local one: centralized access to multiple Lansweeper installations, more granular permissions over assets, a new report builder, a fully integrated API, and more.
...
- ****Advantages****:
  ...
  - In Lansweeper Sites, asset access can be managed using [scopes](/classic/docs/configure-scopes-permissions-and-roles).
- ****Disadvantages:****
...
- ****Advantages****:
  ...
  - In Lansweeper Sites, asset access across the various installations can be managed using [scopes](/classic/docs/configure-scopes-permissions-and-roles).
- ****Disadvantages****:
  ...
  - If multiple local installations do scan the same assets, these assets may be sent to Sites multiple times, generating unnecessary traffic and increasing the risk of [duplicates](/classic/docs/asset-deduplication-in-cloud).
...
- ****Advantages****:
  ...
  - Within each company site, asset access can be managed further using [scopes](/classic/docs/configure-scopes-permissions-and-roles).
- ****Disadvantages****:
