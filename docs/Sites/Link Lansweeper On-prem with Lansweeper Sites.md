...
This page is for Lansweeper On-prem. For Lansweeper Sites, see [Link Lansweeper Sites with Lansweeper On-prem](/classic/docs/link-lansweeper-sites-with-lansweeper-on-prem).
...
If you're an existing customer with a Lansweeper On-prem installation, [link your installation with a Lansweeper Site](/classic/docs/link-lansweeper-on-prem-with-lansweeper-sites "Link your cloud site").  
...
2. Select **Link with Cloud site**. If you have multiple scan servers, you will be asked which one should be responsible for syncing with Lansweeper Sites. This server will be the sync server.  
   ...
   If any prerequisite checks have failed, follow the provided instructions to resolve them and select **Retry** when you're ready. For more information, see [Lansweeper Sites linking requirements](/classic/docs/cloud-linking-requirements "Cloud linking requirements").
...
8. Your Lansweeper Site will display your installation's data in the **Inventory** module. More information on the **Inventory** module can be found in [View assets](/classic/docs/view-assets).  
