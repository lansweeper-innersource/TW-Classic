...
2. Select **Add scanning target**.   
   ![Nils_0-1677840764400.png](/docs/.document360/assets/article_387/image_002.jpg)
...
4. Enter the target credentials:
   ...
   - Description: an optional description for your scanning target. This is for personal reference only.  
     ![Scan SCCM cloud 1.png](/docs/.document360/assets/article_387/image_003.jpg)
5. Select a scanning schedule for the SCCM target.
6. Select **Save and exit**, or **Save target**![Nils_1-1677841287288.png](/docs/.document360/assets/article_387/image_004.jpg).
7. In the pop-up, choose whether you want to scan the SCCM target immediately.  
   ![Execute scanning target.png](/docs/.document360/assets/article_387/image_005.jpg)
