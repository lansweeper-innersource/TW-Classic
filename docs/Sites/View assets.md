...
Assets that are affected by vulnerabilities are represented in the **Vulnerabilities** column by the vulnerability icon: ![vulnerability.png](/docs/.document360/assets/article_351/image_002.jpg).
