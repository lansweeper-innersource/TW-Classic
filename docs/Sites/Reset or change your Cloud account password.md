...
You can easily reset your password using the Cloud login page. Browse to [the login page](https://app.lansweeper.com/) and select **Forgot password?**
...
## Cloud password requirements

Your Cloud account password must meet all of the below requirements. If one of these requirements isn't met, you won't be able to submit or use the password.
