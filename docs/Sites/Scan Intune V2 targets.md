...
2. Select [the app you've already created](/docs/create-a-microsoft-cloud-services-application) and select the **API permissions** tab in the left-hand menu.  
   ![Scanning-O365-with-a-Microsoft-cloud-credential-16.jpg](/docs/.document360/assets/article_318/image_002.jpg)
3. On the **API permissions** page, click **Add permission** and select **Microsoft Graph** from the API list.    
   ![Scanning_M365_with_a_Microsoft_cloud_credential_6.jpg](/docs/.document360/assets/article_318/image_003.jpg)
4. As we are setting up the Microsoft Graph API to enforce modern authentication, you will need to add Application permissions. Start by selecting **Application permissions**.   
   ![Scanning_with_a_Microsoft_cloud_credential_6.jpg](/docs/.document360/assets/article_318/image_004.jpg)
5. Add the **DeviceManagementManagedDevices.Read.All** API permission and select **Save**. This permission is required to scan your Intune data.  
   ![how-to-scan-intune-V2-devices5.jpg](/docs/.document360/assets/article_318/image_005.jpg)
6. Admin consent must still be granted. Select **Grant admin consent for <organization>** and click **Grant**in the resulting pop-up.  
   ![how-to-scan-intune-V2-devices6.jpg](/docs/.document360/assets/article_318/image_006.jpg)  
     
   The added permissions should now show **Granted for <organization>**.  
   ![how-to-scan-intune-V2-devices7.jpg](/docs/.document360/assets/article_318/image_007.jpg)
...
2. Select **Add new credential**.  
   ![Scan intune v2 Cloud 2.png](/docs/.document360/assets/article_318/image_008.jpg)
...
4. Fill in the fields:
   ...
   4. Client Secret or Certificate Thumbprint: obtained when creating the MS Graph app in Azure.  
      ![Scan intune v2 Cloud 3.png](/docs/.document360/assets/article_318/image_009.jpg)
...
2. Select **Add scanning target**.   
   ![Scan intune v2 Cloud 4.png](/docs/.document360/assets/article_318/image_010.jpg)
...
5. Select a Microsoft Cloud Service credential to assign to the Intune V2 scanning target.  
   ![Scan intune v2 Cloud 5.png](/docs/.document360/assets/article_318/image_011.jpg)
6. Select **Save and exit**, or **Save target**![Scan intune v2 Cloud 1.png](/docs/.document360/assets/article_318/image_012.jpg).
