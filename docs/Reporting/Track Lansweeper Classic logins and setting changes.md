...
2. Browse to the **Configuration > Server Options**section of the web console.  
   ![menu-configuration-server-options.jpg](/docs/.document360/assets/article_153/image_001.jpg)
3. Configure how long the logs are kept in the database in the **History Cleanup Options** section of the page.
   ...
   - The second cleanup option determines how quickly logs related to web console logins are removed from the database, specifically from the tblLoginLog table.  
     ![see-who-logged-into-lansweeper-or-made-changes-to-settings-1.jpg](/docs/.document360/assets/article_153/image_002.jpg)
4. Open the built-in reports below, found in the **Reports** menu.  
   - Users: Logins into the Lansweeper web console
   - Users: Changes made to Lansweeper configurationThe first report lists who logged into the Lansweeper web console and when, while the second report lists who made changes to assets or Lansweeper settings and when.![see-who-logged-into-lansweeper-or-made-changes-to-settings-2.jpg](/docs/.document360/assets/article_153/image_003.jpg)![see-who-logged-into-lansweeper-or-made-changes-to-settings-3.jpg](/docs/.document360/assets/article_153/image_004.jpg)
