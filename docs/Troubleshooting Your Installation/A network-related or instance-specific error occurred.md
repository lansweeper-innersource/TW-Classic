...
This article is divided into steps for the [SQL Server](#heading1) database and steps for the [SQL LocalDB](#heading2) server. You can [verify which database server you are using](/docs/identify-which-database-server-lansweeper-is-using) with the ConfigEditor tool or in the Lansweeper web console.
...
1. Stop the **Lansweeper Server** service in **Windows Services**.
   ...
   ![procedure-stopping-the-lansweeper-service.jpg](/docs/.document360/assets/article_277/image_002.jpg)
2. Stop your web server service in **Windows Services**. Your web server service is either IIS Express or World Wide Web Publishing Service (IIS).
   ...
   ![procedure-stopping-the-web-server-service.jpg](/docs/.document360/assets/article_277/image_003.jpg)
3. Make sure the **SQL Server** and **SQL Server Browser** services are running at all times on the server hosting your SQL instance.  
   - Right-click one of the services in Windows Services.  
     ![procedure-checking-sql-service-status.jpg](/docs/.document360/assets/article_277/image_004.jpg)
   - Select the **Properties** menu item.  
     ![procedure-checking-sql-service-properties.jpg](/docs/.document360/assets/article_277/image_005.jpg)
   - Set the service's startup type to **Automatic** in the resulting pop-up and select **OK**.  
     ![procedure-checking-sql-service-startup-type.jpg](/docs/.document360/assets/article_277/image_006.jpg)
   - Right-click the service and select **Start**, if the service is not already started.  
     ![procedure-starting-sql-service.jpg](/docs/.document360/assets/article_277/image_007.jpg)
...
5. Make sure your SQL instance is configured for mixed (Windows and SQL) authentication, as the Lansweeper service and web console use a SQL user called "lansweeperuser" to connect to the database.  
   ...
   - Select the **Properties** menu item.  
     ![procedure-checking-sql-instance-properties.jpg](/docs/.document360/assets/article_277/image_008.jpg)
   - Select the **Security** tab in the resulting pop-up.
   - Tick **SQL Server and Windows Authentication mode**. **![procedure-checking-sql-server-authentication.jpg](/docs/.document360/assets/article_277/image_009.jpg)**
   - Right-click your SQL instance name and select **Restart**.  
     ![procedure-restarting-sql-instance.jpg](/docs/.document360/assets/article_277/image_010.jpg)
6. If your Lansweeper service and/or web console are hosted on a different server than the Lansweeper database, make sure your SQL instance is set up to allow remote database connections.  
   - Right-click your SQL instance name in SQL Server Management Studio, select **Properties** and open the **Connections** tab in the resulting pop-up.  
     ![procedure-checking-sql-protocol-properties.jpg](/docs/.document360/assets/article_277/image_011.jpg)
   - Tick **Allow remote connections to this server**.  
     ![procedure-enabling-remote-connections-in-management-studio.jpg](/docs/.document360/assets/article_277/image_012.jpg)
   ...
   - Right-click **Named Pipes** and select **Enable**, right-click **TCP/IP** and select **Enable**.  
     ![procedure-checking-sql-protocols.jpg](/docs/.document360/assets/article_277/image_013.jpg)
   - Right-click **TCP/IP**, select **Properties** and ensure that connectivity is enabled for the appropriate IPs in the **IP Addresses** tab.  
     ![procedure-checking-sql-protocol-ips.jpg](/docs/.document360/assets/article_277/image_014.jpg)
   - Right-click the SQL Server service under SQL Server Services and select **Restart**.  
     ![procedure-restarting-sql-service-in-configuration-manager.jpg](/docs/.document360/assets/article_277/image_015.jpg)
...
8. Make sure your Data Source (SQL instance name) is correctly submitted in the ConfigEditor tool, found at `Program Files (x86)\Lansweeper\Tools\ConfigEditor.exe` on the servers hosting your **Lansweeper Server** service and web console.   
   ...
   ![procedure-checking-sql-instance-name-in-management-studio.jpg](/docs/.document360/assets/article_277/image_016.jpg)  
   If it doesn't, select the Data Source in each ConfigEditor tab and select **Edit** to correct it.  
   ![procedure-configeditor-data-source-change.jpg](/docs/.document360/assets/article_277/image_017.jpg)  
...
2. (Re)start the **Lansweeper LocalDB Service** on your Lansweeper server.
   ...
   ![procedure-starting-lansweeper-localdb-service.jpg](/docs/.document360/assets/article_277/image_018.jpg)
3. (Re)start the **Lansweeper Server** service**.**

   ![procedure-restarting-the-lansweeper-service.jpg](/docs/.document360/assets/article_277/image_019.jpg)
4. (Re)start your web server service. Your web server service is either IIS Express or World Wide Web Publishing Service (IIS).
   ...
   ![procedure-restarting-the-web-server-service.jpg](/docs/.document360/assets/article_277/image_020.jpg)
