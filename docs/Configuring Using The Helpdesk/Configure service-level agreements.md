...
![illustration-ticket-slas.jpg](/docs/.document360/assets/article_018/image_001.jpg)

## Configure SLAs

1. Browse to the **Configuration > General Settings**section of the web console.  
   ![menu-configuration-general-settings.jpg](/docs/.document360/assets/article_018/image_002.jpg)
2. Submit your company's opening hours in the **Business hours** section of the page. SLAs can be made to take these office hours into account.  
   ![configuring-service-level-agreements-1.jpg](/docs/.document360/assets/article_018/image_003.jpg)
3. Delete the built-in SLA and select **Add SLA** in the **Service-level agreement** section of the page to create your own SLA. Alternatively, adjust the built-in SLA to suit your needs. If you create multiple SLAs and a ticket meets the criteria of all of them, the first SLA in the list will be applied to the ticket. The SLA list can be rearranged using the green arrows.![configuring-service-level-agreements-2.jpg](/docs/.document360/assets/article_018/image_004.jpg)
   - **Name**: SLA name.
