...
2. To create your own ticket type, select **Add Ticket Type** in the **Ticket types** section of the page. You'll see several built-in ticket types here as well.
   ...
   - **Custom fields**: optionally, custom fields that are linked to the specified ticket type. Instructions for setting up ticket custom fields can be found in [this knowledge base article](/classic/docs/create-and-add-custom-fields-to-ticket-types).
