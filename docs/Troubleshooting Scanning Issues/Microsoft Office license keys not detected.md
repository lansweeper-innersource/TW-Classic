...
- [Upgrade to the latest Lansweeper release](/docs/update-lansweeper-on-premises "Update your Lansweeper Classic installation").
- [Rescan your assets](/docs/how-to-scan-a-windows-computer "Scan your Windows computer").
