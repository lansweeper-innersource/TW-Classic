...
To solve the error, disable the `tty` requirement to ensure Lansweeper has `sudo` access and fulfills the [requirements for scanning Linux computers](/classic/docs/linux-and-unix-agentless-scanning-requirements "Linux and Unix scanning requirements").
...
[Run a scan on your Linux computer](/classic/docs/how-to-scan-a-linux-or-unix-computer "How to scan a Linux or Unix computer") to confirm the error is resolved.
