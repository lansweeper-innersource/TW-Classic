...
Lansweeper allows you to [scan extra SNMP data with custom OID scanning](/docs/scan-extra-snmp-data-with-custom-oid-scanning).
...
2. Make sure there is an OID listed in the device's Summary tab, indicating that Lansweeper is able to access the SNMP protocol on the device. If there isn't, [troubleshoot the SNMP access issue](/docs/troubleshoot-snmp-scanning-issues "Troubleshooting SNMP scanning issues"). Custom OID scanning cannot retrieve data if the SNMP protocol in general is not accessible on the device.

   ![troubleshooting-custom-oid-scanning-issues-6.jpg](/docs/.document360/assets/article_270/image_002.jpg)
3. Go to **Scanning > Custom OID** scanning and make sure the **Enabled** checkbox is selected.

   ![troubleshooting-custom-oid-scanning-issues-3.jpg](/docs/.document360/assets/article_270/image_003.jpg)
...
5. Make sure your OID target's Manufacturer and Model are either empty or correspond exactly with what is listed on the device's Lansweeper webpage.
   ...
   ![troubleshooting-custom-oid-scanning-issues-1.jpg](/docs/.document360/assets/article_270/image_004.jpg)

   ![troubleshooting-custom-oid-scanning-issues-2.jpg](/docs/.document360/assets/article_270/image_005.jpg)
6. Make sure the OID submitted in your OID target is correct and contains data. You can use the tool below, found on your Lansweeper server, for troubleshooting. Run the tool from your Lansweeper server and submit your device's IP address and SNMP scanning credential. In the SNMP Custom OIDs field, submit the OIDs you'd like to test. Multiple OIDs can be submitted, separated with commas.
   ...
   ![troubleshooting-custom-oid-scanning-issues-5.jpg](/docs/.document360/assets/article_270/image_006.jpg)
...
8. Check the **Scanned OIDs** tab on individual asset pages or reports in the **Reports** tab for the retrieved data.
   ...
   ![troubleshooting-custom-oid-scanning-issues-4.jpg](/docs/.document360/assets/article_270/image_007.jpg)
