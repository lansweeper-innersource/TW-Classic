...
3. Scan for Open Ports. Ensure that the TCP port **443 (HTTPS)** is open on the XenServer host.
   ...
   ![Citrix-scanning-troubleshooting-1.jpg](/docs/.document360/assets/article_268/image_002.jpg)
4. Scan HTTPS. Ensure the Title of the machine contains the text **XenServer** or **Citrix Hypervisor**.![Citrix-scanning-troubleshooting-2.jpg](/docs/.document360/assets/article_268/image_003.jpg)
