...
3. Paste the executable to the folder referenced by your script, policy, or task.![sophie_1-1682518481128.jpeg](/docs/.document360/assets/article_257/image_002.jpg)
...
![sophie_0-1682518466115.jpeg](/docs/.document360/assets/article_257/image_003.jpg)
...
![procedure-importing-lspush-file.jpg](/docs/.document360/assets/article_257/image_004.jpg)
...
3. Check the machine has not been excluded based on name, domain, IP address, IP range or asset type. No assets are created for machines that are excluded from scanning.
   ...
   ![procedure-checking-scanning-exclusions.jpg](/docs/.document360/assets/article_257/image_005.jpg)
