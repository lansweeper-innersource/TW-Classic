...
2. Tick the checkboxes in front of the assets you want to delete.
...
1. Browse to the asset's detailed page and select **Edit asset** under **Asset options**.
2. Select **Delete asset** under **Asset options**.
