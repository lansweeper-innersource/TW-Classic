...
![adding-manufacturer-support-links-1.jpg](/docs/.document360/assets/article_124/image_001.jpg)
...
1. Browse to the **Configuration > Asset Pages**section of the web console.![menu-configuration-asset-pages.jpg](/docs/.document360/assets/article_124/image_002.jpg)
...
4. Enter the URL the asset serial should link to into the Support Link field of the pop-up window and select **Ok**.   
   ...
   ![adding-manufacturer-support-links-2.jpg](/docs/.document360/assets/article_124/image_003.jpg)

   ![adding-manufacturer-support-links-3.jpg](/docs/.document360/assets/article_124/image_004.jpg)
