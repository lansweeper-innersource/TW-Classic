...
- Browse to the asset's details and select **Edit asset** under **Asset options**. Select an asset type from the dropdown and ensure the box next to the dropdown is checked, indicating that your changes won't be overridden during scanning. Select **Save asset** to save your changes.![changing-an-assets-asset-type-1.jpg](/docs/.document360/assets/article_125/image_001.jpg)
- Go to the **Assets** sections and select **Editing Mode** under **Options**. Place your cursor in the Type column, select an asset type from the dropdown, and select **Ok**.![changing-an-assets-asset-type-2.jpg](/docs/.document360/assets/article_125/image_002.jpg)
- Go to the **Assets** section, tick the checkboxes in front of the assets of your choice, and select **Mass Edit Assets** under **Asset Actions**. In the resulting pop-up, select the Asset Type field, choose your preferred asset type for the assets you selected, and select **Change Field(s)**![changing-an-assets-asset-type-3.jpg](/docs/.document360/assets/article_125/image_003.jpg)
