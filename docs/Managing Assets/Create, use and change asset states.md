...
2. Select **Add Asset state** in the **Asset States** section of the page.
...
- Browse to an asset's detailed page and select **Edit asset** under **Asset options**. Select an asset state from the dropdown and select **Save asset**.
...
- Go to the **Assets** section of the web console and select **Editing Mode** under **Options**. Place your cursor in the State column, select a state from the dropdown and select **Ok**.
