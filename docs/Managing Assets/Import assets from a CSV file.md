...
1. Browse to the **Assets > Import Assets**section of the web console.
...
3. Open your template, add assets to it and save it as a .csv file. Each line represents one asset.
   - Use the same [date format configured in your web console](/classic/docs/set-the-date-format).
...
6. When you've resolved any errors, select **Import Assets**.
