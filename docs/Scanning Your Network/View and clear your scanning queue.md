...
The following types of scans are not visible in your scanning queue but are processed silently in the background: [Active Directory User/Group Path](/classic/docs/scanning-with-an-active-directory-usergroup-path-scanning-target), [AirWatch](/classic/docs/scan-mobile-devices-through-vmware-workspace-one-uem-powered-by-airwatch), [AWS](/classic/docs/scan-an-aws-cloud-environment), [Azure](/classic/docs/scan-an-azure-cloud-environment), [Chrome OS](/classic/docs/how-to-scan-chrome-os-machines), [Intune](/classic/docs/scan-mobile-devices-through-microsoft-intune), [SCCM](/classic/docs/integrate-lansweeper-with-sccm), [event log](/classic/docs/scanning-with-an-eventlog-only-scanning-target) and [warranty scans](/classic/docs/set-up-automated-warranty-checks).
