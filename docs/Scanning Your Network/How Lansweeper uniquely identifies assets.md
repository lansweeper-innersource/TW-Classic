...
The monitor manufacturer is referenced with a 3-letter code in the monitor's unique key. A list of 3-letter codes and the monitor manufacturers they belong to can be found in [this knowledge base article](/classic/docs/list-of-3-letter-monitor-manufacturer-codes).
