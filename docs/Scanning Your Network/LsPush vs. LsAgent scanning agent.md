...
The overview below compares LsPush to LsAgent. More detailed information on LsPush can be found in [this knowledge base article](/docs/introduction-to-the-lspush-scanning-agent-for-windows), while more detailed information on LsAgent can be found in [this knowledge base article](/docs/introduction-to-lsagent-for-windows-linux-and-mac).

|  | [LsPush](/docs/introduction-to-the-lspush-scanning-agent-for-windows) | [LsAgent](/docs/introduction-to-lsagent-for-windows-linux-and-mac) |
| --- | --- | --- |
