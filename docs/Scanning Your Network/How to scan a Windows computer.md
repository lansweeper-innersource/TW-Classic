...
![how-to-scan-a-windows-computer-1.jpg](/docs/.document360/assets/article_191/image_002.jpg)
...
2. In your web console, go to **Scanning > Scanning targets**, and select **Add Scanning Target**. ![Scanning targets 1.png](/docs/.document360/assets/article_191/image_003.jpg)  
...
3. Go to **Scanning > Scanning credentials**, and select **Add new Credential**.  
   ![Scanning targets 2.png](/docs/.document360/assets/article_191/image_004.jpg)
4. In the popup, select **Windows** as the **Type**, and enter your Windows username and password.  
   ...
   ![Scanning targets 3.png](/docs/.document360/assets/article_191/image_005.jpg)  
...
5. If the credential you set up is not a global credential, you will need to map the credential to your computer's domain/workgroup, name, IP address or IP range.  
   ...
   ![Scanning targets 4.png](/docs/.document360/assets/article_191/image_006.jpg)
