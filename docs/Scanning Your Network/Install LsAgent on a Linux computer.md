...
1. Make sure your Linux OS is supported [as described in this article](/classic/docs/lsagent-installation-requirements#heading2 "LsAgent installation requirements").
