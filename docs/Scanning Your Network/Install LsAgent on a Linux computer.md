...
3. If you will be scanning the Linux computer over the internet, enable access to the Lansweeper relay server under **Scanning > Relay Configuration** in the Lansweeper web console. The relay access check may take a minute to complete. If you have multiple scanning servers, you can configure which one collects relay data.
   ...
   ![procedure-requesting-relay-access.jpg](/docs/.document360/assets/article_197/image_002.jpg)
4. Copy the Cloud Relay Authentication Key seen on the page, as you will need to submit this in the LsAgent installer later.  
   ![procedure-relay-access-granted.jpg](/docs/.document360/assets/article_197/image_003.jpg)
...
8. Choose an installation directory and click **Next**.  
   ![installing-lsagent-on-a-linux-computer-2.jpg](/docs/.document360/assets/article_197/image_004.jpg)
...
![installing-lsagent-on-a-linux-computer-6.jpg](/docs/.document360/assets/article_197/image_005.jpg)
...
![installing-lsagent-on-a-linux-computer-7.jpg](/docs/.document360/assets/article_197/image_006.jpg)

![procedure-changing-lsagent-schedule.jpg](/docs/.document360/assets/article_197/image_007.jpg)
...
![procedure-linking-scanning-servers-to-lsagent-group.jpg](/docs/.document360/assets/article_197/image_008.jpg)
