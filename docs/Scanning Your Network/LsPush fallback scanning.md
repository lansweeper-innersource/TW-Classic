...
- Uncheck the **Enable fallback scanning** box in the **Configuration > Server Options**section of the web console.
  ...
  ![menu-configuration-server-options.jpg](/docs/.document360/assets/article_206/image_001.jpg)

  ![lspush-fallback-scanning-1.jpg](/docs/.document360/assets/article_206/image_002.jpg)
