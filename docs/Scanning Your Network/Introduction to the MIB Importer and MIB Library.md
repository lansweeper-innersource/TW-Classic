...
Browse to the following section of the web console: **Scanning > MIB Importer**.  ![Nils_0-1672926398298.jpeg](/docs/.document360/assets/article_204/image_001.jpg)

### Step 4: choose your files

Click **Choose Files** and select the MIB file you want to import. You can select multiple files.   
![MIB-Importer-1.jpg](/docs/.document360/assets/article_204/image_002.jpg)
...
![OID-selected-from-MIB.jpg](/docs/.document360/assets/article_204/image_003.jpg)
...
![OID-add-to-existing-target.jpg](/docs/.document360/assets/article_204/image_004.jpg)
...
![OID-add-to-new-target.jpg](/docs/.document360/assets/article_204/image_005.jpg)

### Step 7: rescan your assets

Rescan the assets linked to a custom OID target to retrieve the OID data you configured. You can find scanned data in the **Scanned OIDs** tab of the asset's page. ![Scanned-OID-example.jpg](/docs/.document360/assets/article_204/image_006.jpg)
...
![menu-scanning-mib-library.jpg](/docs/.document360/assets/article_204/image_007.jpg)
...
 ![introduction-to-the-mib-importer-and-mib-library-1.jpg](/docs/.document360/assets/article_204/image_008.jpg)
