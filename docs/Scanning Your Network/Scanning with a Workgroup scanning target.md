...
Due to their reliance on the old SMB1 protocol, scanning targets of the type Workgroup are marked as deprecated. It is strongly advised to use other types of scanning, e.g. [IP Range](/docs/scanning-with-an-ip-range-scanning-target) targets, to scan workgroup assets.
...
![scanning-with-a-workgroup-scanning-target-1.jpg](/docs/.document360/assets/article_234/image_001.jpg)
...
You can submit a description for the target as well. If you have multiple scanning servers, there will be multiple configuration tabs on the **Scanning Targets** page, one for each server. As agentless scanning of Windows computers requires credentials, make sure to submit and map your Windows scanning credentials as well, by following the instructions in [this knowledge base article](/docs/create-and-map-scanning-credentials).

![menu-scanning-scanning-targets.jpg](/docs/.document360/assets/article_234/image_002.jpg) ![scanning-with-a-workgroup-scanning-target-2.jpg](/docs/.document360/assets/article_234/image_003.jpg)
