...
1. Browse to the **Scanning > Scanning Targets** menu of the web console. If you have multiple scan servers, there will be a tab for each server.   
   ...
   ![menu-scanning-scanning-targets.jpg](/docs/.document360/assets/article_245/image_002.jpg)
...
3. In the resulting pop-up, you can choose whether to use LDAP or LDAPS for connections to the domain, as well as the ports.   
   ...
   ![ldaps-config.png](/docs/.document360/assets/article_245/image_003.jpg) For connections to your domain in the context of scanning and other operations, Lansweeper will try ports and protocols in this order until one is successful:
