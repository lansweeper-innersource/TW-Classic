...
- **Adsi Path**: the computer container or organizational unit should be entered.
  ...
  If you want computers that are disabled in AD to be included in your scan, make sure this option is ticked in the **Configuration > Server Options** section of the web console. More information can be found in [this knowledge base article](/classic/docs/how-to-scan-disabled-active-directory-users-and-computers).
