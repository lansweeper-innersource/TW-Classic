...
1. Go to the **Scanning > Scanning Targets**section of the web console.  
   ![menu-scanning-scanning-targets.jpg](/docs/.document360/assets/article_232/image_001.jpg)
2. Select **Add Scanning Target**.  
   ![scanning-with-an-eventlog-only-scanning-target-1.jpg](/docs/.document360/assets/article_232/image_002.jpg)
...
![scanning-with-an-eventlog-only-scanning-target-2.jpg](/docs/.document360/assets/article_232/image_003.jpg)
