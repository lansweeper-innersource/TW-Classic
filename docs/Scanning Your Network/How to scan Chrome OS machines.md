...
![how-to-scan-chrome-os-devices-3.jpg](/docs/.document360/assets/article_192/image_001.jpg)
...
![18-Add-Scanning-Target-1.jpg](/docs/.document360/assets/article_192/image_002.jpg)

Select **Chrome OS** from the drop-down menu, submit a credential name, username and the JSON key. The name field is for your reference, the username field requires a user with the Services Admin role in your Google environment. The JSON key is the credential you created in step 1. Configure the scanning schedule and click **Ok** to create your scanning target.  ![how-to-scan-chrome-os-devices-4.jpg](/docs/.document360/assets/article_192/image_003.jpg)

### Step 3: view your Chrome OS assets

When the scanning target has been added, it will immediately start scanning. You can view your scanned assets by selecting the Chrome OS asset type under the **Assets** tab. ![19-View-Chrome-OS-assets.jpg](/docs/.document360/assets/article_192/image_004.jpg)
