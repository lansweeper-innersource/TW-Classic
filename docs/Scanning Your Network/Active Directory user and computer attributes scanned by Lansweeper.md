...
If you haven't scanned your Active Directory users or computers yet, you can check out [this article for further information on how to scan users](/docs/how-to-scan-users) and [this article for further information on how to scan computers](/docs/scanning-with-an-active-directory-computer-path-scanning-target).
...
![Active-Directory-user-and-computer-attributes-scanned-by-Lansweeper-1.jpg](/docs/.document360/assets/article_177/image_001.jpg) ![Active-Directory-user-and-computer-attributes-scanned-by-Lansweeper-2.jpg](/docs/.document360/assets/article_177/image_002.jpg)
...
The BitLocker recovery keys can only be seen by users with the Access BitLocker Recovery Keys permission. More information on web console permissions can be found in [this article](/docs/web-console-user-roles-and-permissions).

![Active-Directory-user-and-computer-attributes-scanned-by-Lansweeper-3.jpg](/docs/.document360/assets/article_177/image_003.jpg)
