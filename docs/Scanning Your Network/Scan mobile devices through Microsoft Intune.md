...
2. Select [the app you've already created](/docs/create-a-microsoft-cloud-services-application) and select the **API permissions** tab in the left-hand menu.  
   ![Scanning-O365-with-a-Microsoft-cloud-credential-16.jpg](/docs/.document360/assets/article_224/image_002.jpg)
3. On the **API permissions** page, click **Add permission** and select **Microsoft Graph** from the API list.    
   ![Scanning_M365_with_a_Microsoft_cloud_credential_6.jpg](/docs/.document360/assets/article_224/image_003.jpg)
4. As we are setting up the Microsoft Graph API to enforce modern authentication, you will need to add Application permissions. Start by selecting **Application permissions**.   
   ![Scanning_with_a_Microsoft_cloud_credential_6.jpg](/docs/.document360/assets/article_224/image_004.jpg)
5. Add the **DeviceManagementManagedDevices.Read.All** API permission and select **Save**. This permission is required to scan your Intune data.  
   ![how-to-scan-intune-V2-devices5.jpg](/docs/.document360/assets/article_224/image_005.jpg)
6. Admin consent must still be granted. Select **Grant admin consent for <organization>** and click **Grant**in the resulting pop-up.  
   ![how-to-scan-intune-V2-devices6.jpg](/docs/.document360/assets/article_224/image_006.jpg)  
     
   The added permissions should now show **Granted for <organization>**.  
   ![how-to-scan-intune-V2-devices7.jpg](/docs/.document360/assets/article_224/image_007.jpg)
...
3. Select **Microsoft Cloud Service** as a credential type, and fill in the name, Application ID and Directory ID. Application ID and Directory ID are obtained when [creating the Microsoft Cloud Services application](/docs/create-a-microsoft-cloud-services-application).
...
5. Optionally, add a new scanning target from this pop-up. Select the designated checkboxes and click **OK**. The corresponding scanning target will be created.  
   ![Scan mobile devices 2.png](/docs/.document360/assets/article_224/image_008.jpg)  

   When multiple scanning targets are selected, ensure that the app has sufficient [API permissions](/docs/create-a-microsoft-cloud-services-application#HowToScanAndMail "Creating a Microsoft Cloud Services application for scanning and email") to scan the selected scanning targets.
...
3. Select **Intune**as a target type.  
   ![Scan intune Classic 1.png](/docs/.document360/assets/article_224/image_009.jpg)
